...
const BusinessAnalysisPage = React.lazy(() => import("./pages/BusinessAnalysisPage").then((module) => ({ default: module.BusinessAnalysisPage })));
...
const router = createBrowserRouter([{ element: <AppShell/>, children: [
  ...
  { path: "/business", element: <Navigate to="/business/advertising" replace /> },
  { path: "/business/:topic", element: <React.Suspense fallback={<PageLoader />}><BusinessAnalysisPage/></React.Suspense> },
